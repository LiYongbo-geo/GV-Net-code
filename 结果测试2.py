...
if __name__ == '__main__': 
    ...
    '''
    nzyx = (32,64,64)
    density_modeltwo = np.zeros(shape = [32, 64 ,64])+1e-5

    density_modeltwo[4:8, 22:42, 10:18] = 0.8
    density_modeltwo[8:12, 22:42, 16:24] = 0.8
    density_modeltwo[12:16, 22:42, 22:30] = 0.8
    density_modeltwo[16:20, 22:42, 28:38] = 0.8
    density_modeltwo[20:24, 22:42, 36:46] = 0.8

    den_modelone = torch.from_numpy(density_modeltwo)
    ...
    torch.onnx.export(netEnc, (dummy_input, ), 'modelo.onnx')
    ...
    with torch.no_grad():
        ...
        np.save("modetwo_rec.npy", tru_model)
        '''
