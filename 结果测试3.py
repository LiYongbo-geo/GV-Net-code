...
if __name__ == '__main__':
    ...
    density_modelthree = np.zeros(shape = [32, 64 ,64])+1e-5
    density_modelthree[3:8, 22:42, 22:42] = 0.8
    density_modelthree[18:24, 22:42, 22:42] = 0.6

    den_modelone = torch.from_numpy(density_modelthree)
    ...
    with torch.no_grad():
        ...
        np.save("modethree_rec.npy", tru_model)
